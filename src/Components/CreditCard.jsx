...
const content = {
  ...
  return (
    <>
      <HeroSection
        ...
        buttonLink="#"
        backgroundImage="credit-card-hero-img"
      />
  ...
  cta={{
    title: "Start",
    highlight: " Accepting",
    title2: " Credit Cards Today",
    des: "Set up your merchant account in minutes and start processing payments with confidence.",
    primaryBtn: { label: "Apply Now", href: "/signup" },
    secondaryBtn: { label: "Talk to a Specialist", href: "/demo" },
  }}
/>
      </section>
    </>
